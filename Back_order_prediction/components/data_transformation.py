...
from Back_order_prediction.entity.config_entity import DataIngestionConfig ,DataTransformationConfig ,DataValidationConfig
from Back_order_prediction.entity.artifact_entity import DataIngestionArtifact,DataTransformationArtifact,DataValidationArtifact

from Back_order_prediction.constant import *

from sklearn.compose import ColumnTransformer
from Back_order_prediction.utils.utils import read_yaml_file, load_data, save_numpy_array_data, save_object
from Back_order_prediction.constant import *
...
# utils
            ...
            transform_columns = schema[TRANSFORM_COLUMN_KEY]
            
            continuous_columns=[feature for feature in transform_columns if len(train_df[feature].unique())>=25]
...
#input_feature_train_df = X
#target_feature_train_df = y
...
# The SMOTE algorithm is used to oversample the minority class by creating synthetic samples, 
# while Tomek is used to remove the noisy samples and undersample the majority class
