...
from Back_order_prediction.entity.config_entity import DataValidationConfig
from Back_order_prediction.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact
...
from Back_order_prediction.entity.raw_data_validataion import IngestedDataValidataion
...
#train_file_path from the data ingestion file

            self.train_data = IngestedDataValidataion(
                validate_path=self.data_ingestion_artifact.train_file_path, schema_path=self.schema_path)
# for test            
            self.test_data = IngestedDataValidataion(
    ...
    def isFolderPathAvailable(self) -> bool:
        try:
            # true-  file is available, false- file is not available
    ...
    def initiate_data_validation(self):
        try:
            data_validation_artifact= DataValidationArtifact(
                ...
                message = "data validatioon performed successfully"
            )
